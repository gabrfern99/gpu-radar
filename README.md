...
**Greater Goiânia + Anápolis** and a **R$ 1.500** ceiling. It sweeps OLX on a
...
variant hurt, your own city is worth a little, and a seller who has already
dropped the price is a seller worth talking to.
...
OLX's own region filter helps but leaks — Uruaçu, Cocalzinho and Nova Glória
all turned up in a "Grande Goiânia e Anápolis" search. So `region.py` filters
a second time against an explicit allowlist: the 21 municipalities of the
Região Metropolitana de Goiânia, plus Anápolis.
...
- Filter by text, brand, city, price ceiling, minimum tier and deal class;
  toggle whole PCs, suspects, and expired ads.
...
| `extra_cities` | `[]` | widen the geographic allowlist |
